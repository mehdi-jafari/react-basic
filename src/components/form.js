    ...
    return (
      <form className="form-horizontal" onSubmit={this.handleSubmit}>
        <div className="form-group">
          <lable htmlFor="address" className="col-sm-2 control-label">Address</lable>
        ...
        <div className="form-group">
          <lable htmlFor="datestart" className="col-sm-2 control-label">Start Date</lable>
          ...
          <lable htmlFor="dateend" className="col-sm-2 control-label">End Date</lable>
          <div className="col-sm-4">
        ...
        <div className="form-group">
          <lable htmlFor ="radius" className="col-sm-2 control-label">Radius (km)</lable>
          <div className="col-sm-4">
          ...
          <lable htmlFor="category" className="col-sm-2 control-label">Category</lable>
          <div className="col-sm-4">
